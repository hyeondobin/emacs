...
#+begin_src emacs-lisp :lexical t
(+general-global-application
  "o#" '(org-agenda-list-stuck-projects :which-key "org-agenda-list-stuck-projects")
  "o/" '(org-agenda-in-agenda-files :which-key "org-agenda-in-agenda-flies")
  "oa" '((lambda () (interactive) (org-agenda nil "a"))
         :which-key "agenda")
  "oe" '(org-store-agenda-views :which-key "store agenda views")
...
(org-agenda-sorting-strategy
 '((agenda time-up priority-down category-keep)
   (todo priority-down category-keel)
